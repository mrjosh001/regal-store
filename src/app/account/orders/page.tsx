    ...
    <div className="min-h-screen bg-[#faf9f7]">
      <div className="bg-white border-b border-black/5 sticky top-0 z-40">
        <div className="max-w-lg mx-auto px-4 h-14 flex items-center">
          ...
          <span className="ml-4 font-semibold text-sm capitalize">{status.replace("-", " ")} Orders</span>
        </div>
      </div>
      <main className="max-w-lg mx-auto px-4 py-12 text-center">
        <p className="text-black/40 text-sm mb-2">No orders in this status yet</p>
        <p className="text-black/30 text-xs mb-6">When you place orders they will appear here.</p>
